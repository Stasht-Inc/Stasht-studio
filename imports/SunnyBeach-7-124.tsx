...
import { imgAdobeStock481724704Preview1 } from "./svg-m9vz9";
  ...
  return (
    <div className="bg-gradient-to-b from-50% from-[#00000000] h-[280px] relative rounded-[58px] shrink-0 to-[#39313199] to-[95.673%] w-full">
      <div className="flex flex-row items-end justify-center relative size-full">
        <div className="box-border content-stretch flex flex-row gap-[11px] h-[280px] items-end justify-center px-8 py-6 relative w-full">
          <Frame747 />
        </div>
      </div>
    </div>
